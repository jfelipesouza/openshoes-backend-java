...
public class ProductController {
	...
	public ResponseEntity<ProductDto> updateProduct(@Valid @PathVariable("idproduct") Long idproduct,
	...
	@ApiOperation(value = "Busca produtos de acordo com o nome do modelo")
