...
class ProductServiceTest {
	...
	void setup() {
		...
		validProduct = new Product("Nike", 200.00, size, "url_da_imagem", validCategory, "José", true);
		invalidProduct = new Product("Nike", 200.00, size, "url_da_imagem", invalidCategory, "José", true);
